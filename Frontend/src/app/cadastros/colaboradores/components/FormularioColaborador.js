  ...
  useEffect(() => {
    ...
    if (colaborador) {
      setFormData({
        ...
        cpf: mascararCPF(colaborador.cpf || ''),
        email: colaborador.email || '',
        telefone: mascararTelefone(colaborador.telefone || ''),
        cep: mascararCEP(colaborador.cep || ''),
        cidade: colaborador.cidade || '',
        uf: colaborador.uf || '',
        logradouro: colaborador.logradouro || '',
        bairro: colaborador.bairro || '',
        numero: colaborador.numero || '',
        dataNascimento: colaborador.dataNascimento ? colaborador.dataNascimento.split('T')[0] : '',
        dataAdmissao: colaborador.dataAdmissao ? colaborador.dataAdmissao.split('T')[0] : '',
        setorId: colaborador.setorId ? String(colaborador.setorId) : '',
        cargoId: colaborador.cargoId ? String(colaborador.cargoId) : '',
        active: colaborador.active ?? true
      });
    } else {
      setFormData({
        name: '',
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {colaborador ? 'Editar Colaborador' : 'Cadastrar Novo Colaborador'}
          </DialogTitle>
          <DialogDescription>
            {colaborador
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <section id="tour-colab-form-pessoal">
          ...
          <section id="tour-colab-form-contato">
          ...
          <section id="tour-colab-form-endereco">
          ...
          <section id="tour-colab-form-datas">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="dataAdmissao">
                  Data de Admissão {colaborador ? <span className="text-destructive">*</span> : ''}
                </Label>
                <Input
                  id="dataAdmissao"
                  type="date"
          ...
          <section id="tour-colab-form-vinculos">
          ...
          <div id="tour-colab-form-botoes" className="flex justify-end gap-3 pt-4">
