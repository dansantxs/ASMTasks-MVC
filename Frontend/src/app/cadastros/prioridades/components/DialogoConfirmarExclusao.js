  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            {possuiTarefasAtivas ? 'Não é possível excluir a prioridade' : 'Confirmar exclusão'}
          </AlertDialogTitle>
          <AlertDialogDescription asChild>
            {possuiTarefasAtivas ? (
              <div className="space-y-4">
                <div>
                  A prioridade <strong>"{prioridade.name}"</strong> não pode ser excluída porque possui{' '}
              ...
              <div className="space-y-4">
                <div>
                  Tem certeza que deseja excluir a prioridade <strong>"{prioridade.name}"</strong>?
                </div>
                <div className="text-sm text-muted-foreground">
