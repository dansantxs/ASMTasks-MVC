...
import { Download, Filter, ListChecks, Flag } from 'lucide-react';
...
const reportTitle = 'Relatorio de Prioridades';
...
export default function PrioridadesReportPage() {
  ...
  const sortedData = useMemo(() => {
    ...
    const sorters = {
      ...
      color: (a, b) => compareStrings(a.color, b.color),
        ...
        steps: [
          {
            ...
            popover: { title: 'Relatório de Prioridades', description: 'Visualize, filtre e exporte os dados das prioridades usadas para classificar tarefas nos projetos.', side: 'bottom', align: 'start' },
          },
          {
  ...
  if (isLoading) {
    return <div className="p-6">Carregando relatorio de prioridades...</div>;
  }
      ...
      <div className="container mx-auto py-8 px-4 space-y-4">
        <div className="flex items-center justify-between">
          <div id="tour-relatorio-cabecalho" className="flex items-center gap-3">
            ...
            <div>
              <h1>Relatorio de Prioridades</h1>
              <p className="text-muted-foreground">Visualize, filtre e exporte os dados de prioridades</p>
            </div>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                  <Label>Busca</Label>
                  <Input
                    placeholder="Busque por nome, descricao ou cor"
                    value={search}
